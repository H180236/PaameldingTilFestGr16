...
public class Validator {
	...
	static final String BOKSTAVER_MED_MELLOMROM= "[a-zA-ZÊ¯Â∆ÿ≈ -]";
	static final String BOKSTAVER= "[a-zA-ZÊ¯Â∆ÿ≈-]";
	...
	public static boolean valider(HttpServletRequest request) {
		...
		return (validFornavn(fornavn) && validEtternavn(etternavn) && 
					validKjonn(kjonn) && validTelNum(telefonnummer));
	}
